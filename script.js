...
const STORY = [
  { icon: '💌', meta: '20th October 2022', title: 'First Met', text: 'From "I have a query" to "I have a forever."' },
  { icon: '💍', meta: '2nd October 2023', title: 'The Proposal', text: 'The most beautiful question, the easiest answer, and the beginning of forever.' },
  { icon: '💍', meta: '22nd October 2026', title: 'The Engagement', text: 'And now, with love all around them, they turn their love into a promise, celebrated by the people who matter most.' }
];
