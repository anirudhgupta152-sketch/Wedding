...
const PLAN_CARDS = [
  { icon: '📍', title: 'Venue & Directions', text: 'Starland Banquets, 99 Satguru Ram Singh Marg, New Delhi', link: 'https://maps.app.goo.gl/pBqCXYmnAXrZLsT18?g_st=iw', linkText: 'Open in Google Maps' }
];
